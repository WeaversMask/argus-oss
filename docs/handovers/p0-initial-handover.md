...
**Date:** _YYYY-MM-DD_
**Phase:** P0 — Foundation
**Last task completed:** _none — project just started_
...
_Nothing yet — this is the seed handover._
...
- **CI:** not yet set up
- **Lint:** not yet set up
- **Dogfooding scan of self:** not yet possible (no tool yet)
...
Project seed. Codebase awaits its first commit.
