...
> How to install, run, and configure Argus. **This guide fills in progressively** — a page lands the phase its capability ships (see [`../plan/03-documentation.md`](../plan/03-documentation.md)). Argus became runnable in Phase 2: [`cli.md`](./cli.md) is the place to start.
...
| [`cli.md`](./cli.md)                     | `argus check` and other commands                          | 🟡 P2-02 (check/init/explain + exit codes) → grows with output formats + `fix` |
