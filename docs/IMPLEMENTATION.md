...
| ------- | ------------------------------------------------------------------ | ---------- | --------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| SEC-02  | PII scrub (history rewrite) + go-public policy                     | 2026-07-04 | [#31](https://github.com/WeaversMask/argus/pull/31) | Maintainer-directed: author/committer personal email rewritten to the noreply address across all 68 commits (filter-branch email map; HEAD tree verified byte-identical; API-verified **0 hits** on origin/main post-force-push). Clean-history artifact repo **argus-oss** created (private, verified) — go-public = maintainer pushes/flips it per [go-public-runbook](./go-public-runbook.md), **voluntary, unscheduled, never agentic** (CLAUDE.md rule). 16 stale merged branches deleted; 7 Dependabot PRs `@dependabot recreate`d onto clean base; repo-local git identity = noreply. Backup: `~/argus-pre-scrub-backup.bundle` (maintainer deletes when satisfied). Old merge commits show unverified signatures (cosmetic) |
