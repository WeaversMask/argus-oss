...
1. _P0-16 — Hook ergonomics: lint-staged pre-commit_ (dep P0-14 ✅)
2. _P0-11 — Third-party notices, prerequisites & contributor guardrail_ (licensing arc resumes; see [archived handover](./handovers/p0-10-license-policy-handover.md); dep P0-10 ✅)
3. _P0-07 — Lightweight dependency audit in CI_ (stopgap pending P11-02 — see [phase-00 task spec](./plan/phases/phase-00-foundation.md))
4. _P0-12 — License-compliance guardrail (SPDX allowlist) in CI + local script_ (deps P0-10 ✅, P0-07)
5. _P0-13 — CI supply-chain hardening_ (after P0-07/P0-12 — shared `ci.yml` edits)
6. _P0-06 — Docker development environment_
7. _P0-08 — Documentation scaffolding + ADR-0001 + SECURITY.md_
8. _P0-09 — Changesets release workflow_
...
| ---------------------- | -------------- | --------- | ------------------------------------------------------------------------------------------------------------- |
| P0 — Foundation        | 🟡 In progress | 8/16      | P0-14 (pnpm 11 + release-age gate, ADR-0003) done 2026-07-02; P0-16 next, then licensing arc resumes at P0-11 |
...
| ------- | -------------------------------------------------------------- | ---------- | ------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0-14   | pnpm 11 upgrade, minimum release age & install-script blocking | 2026-07-02 | _pending_                                         | pnpm 11.5.3 exact-pinned; `minimumReleaseAge: 4320` verified refusing a 1-day-old version; `allowBuilds: {}`; Node ≥22.13 (+`.nvmrc`); ADR-0003. Detail: PR + handover                                                                                                                                                                                                                                                                                                       |
