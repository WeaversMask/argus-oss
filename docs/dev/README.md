...
- **How the work is done — the loop, the gates, and what they don't cover:** [`../workflow.md`](../workflow.md). Read this before your first PR; it is the "why" behind the checklist in `CONTRIBUTING.md`.
